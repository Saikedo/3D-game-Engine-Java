...
public class Loader implements Serializable {
    ...
    private static volatile Loader sSoleInstance;
    ...
    public static Loader getInstance() {
	    if(sSoleInstance == null) {
	        synchronized (Loader.class) {
	            if(sSoleInstance == null) sSoleInstance = new Loader();
            }
        }
	...
	public int loadTexture(String fileName) {
		...
		try {
			...
			e.printStackTrace();
            System.err.println("Loader: loadTexture: Exception - " + e);
			System.exit(-1);
		}
	...
	private TextureData decodeTextureFile(String filename) {
		...
		try {
			...
			e.printStackTrace();
			System.err.println("Loader: decodeTextureFile: Exception - " + e);
			System.exit(-1);
		}
